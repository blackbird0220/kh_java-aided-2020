...
class Outer{
	...
	public Outer() {	//Outer 생성자를 사용하게 되면, 자동적으로 내부 클래스에 대한 인스턴스
	...
	class Inner {	//내부 클래스
		...
		void inMethod() {
			System.out.println("내부 클래스에서 외부 클래서의 멤버 : num "+num);
			System.out.println("내부 클래스에서 외부 클래서의 정적 멤버 변수 접근 : sNum "+sNum);
		}
	}
